...
export class IonosSpaceArtifactsApiClient<O> {
...
export class AxiosIonosSpaceArtifactsApiClient extends IonosSpaceArtifactsApiClient<Axios.AxiosRequestConfig> {
