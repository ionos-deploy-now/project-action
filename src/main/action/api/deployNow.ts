...
import {
  ...
  AxiosIonosSpaceProjectApiClient,
} from './api';

export default class DeployNowClient {
  public readonly projectApi: AxiosIonosSpaceProjectApiClient;
  ...
  constructor(serviceHost: string, apiKey: string) {
    ...
    this.projectApi = new AxiosIonosSpaceProjectApiClient(...axiosClientConfig());
